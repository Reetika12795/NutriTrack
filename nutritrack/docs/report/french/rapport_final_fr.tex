...
% ---- Global table styling: more readable with spacing and lines ----
...
\begin{tabularx}{\textwidth}{C{0.5cm} L{2.5cm} C{1.3cm} L{2.5cm} L{3.5cm} C{1.2cm}}
\toprule
\rowcolor{ntblue}
\textcolor{white}{\textbf{\#}} & \textcolor{white}{\textbf{Source}} & \textcolor{white}{\textbf{Format}} & \textcolor{white}{\textbf{Cible}} & \textcolor{white}{\textbf{Script}} & \textcolor{white}{\textbf{Freq.}} \\
\midrule
1 & API REST OFF & JSON & data/raw/api/ & extract\_off\_api.py & Quotid. \\ \hline
2 & Parquet OFF & Parquet & data/raw/parquet/ & extract\_off\_parquet.py & Hebdo. \\ \hline
3 & ANSES / EFSA & HTML & data/raw/scraping/ & extract\_scraping.py & Mensuel \\ \hline
4 & raw/* (3 sources) & Mixte & data/cleaned/ & aggregate\_clean.py & Quotid. \\ \hline
5 & Produits nettoyes & Parquet & app.products & import\_to\_db.py & Quotid. \\ \hline
6 & app.* & SQL & dw.* (etoile) & etl\_warehouse.py & Quotid. \\ \hline
7 & Parquet nettoye & Parquet & MinIO b/s/g & etl\_datalake\_ingest.py & Quotid. \\ \hline
8 & dw.fact\_* & SQL & gold/*.parquet & publish\_aggregates & Quotid. \\
\bottomrule
\end{tabularx}
\arrayrulecolor{black}
\end{table}
