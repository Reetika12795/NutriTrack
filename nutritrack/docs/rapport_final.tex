...
% ---- NutriTrack logo ----
\includegraphics[width=0.75\textwidth]{nutri_track_logo_v8.pdf}
  ...
  \node[fill=ntgreen!10, draw=ntgreen!40, line width=0.5pt,
    ...
    \begin{tabular}{c}
      ...
      \begin{tabular}{c @{\hspace{2cm}} c}
        \includegraphics[height=2.2cm]{Simplon-HD.png} &
        \includegraphics[height=2.2cm]{PublicisGroupelogo-BlackText-300x300.png} \\
      \end{tabular}
    \end{tabular}
  };
\end{tikzpicture}
