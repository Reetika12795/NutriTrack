...
def add_title_bar(slide, title_text, subtitle_text=None, competency=None):
    ...
    # Title text
    txBox = slide.shapes.add_textbox(
        Inches(0.5), Inches(0.15), SLIDE_WIDTH - Inches(1), Inches(0.55)
    )
    tf = txBox.text_frame
    tf.word_wrap = True
    p = tf.paragraphs[0]
...
def add_bullet_list(slide, items, left, top, width, height,
                    font_size=14, color=DARK_GRAY, bold_prefix=False,
                    bullet_color=GREEN):
...
def add_card(slide, left, top, width, height, title, items,
             fill_color, border_color, title_color=None, icon_char=None):
    ...
    add_textbox(slide, title_text, left + Inches(0.15), y_offset,
                width - Inches(0.3), Inches(0.35),
                font_size=14, color=title_color or border_color, bold=True,
                alignment=PP_ALIGN.CENTER)
    # Items
    if items:
        add_bullet_list(slide, items, left + Inches(0.15), y_offset + Inches(0.4),
                        width - Inches(0.3), height - Inches(0.6),
                        font_size=11, color=DARK_GRAY, bullet_color=border_color)
    return box
...
def add_why_callout(slide, text, top):
    ...
    add_textbox(slide, f"Why? {text}",
                ...
                font_size=11, color=BLUE, bold=False)
...
def add_flow_arrow(slide, x1, y1, x2, y2, color=GRAY):
    ...
    connector = slide.shapes.add_shape(
        MSO_SHAPE.RIGHT_ARROW, min(x1, x2), min(y1, y2),
        abs(x2 - x1) or Inches(0.4), abs(y2 - y1) or Inches(0.15)
    )
...
def add_section_slide(slide, title, subtitle=None, bg_color=GREEN):
    ...
    add_textbox(slide, title,
                Inches(1), Inches(2.5), SLIDE_WIDTH - Inches(2), Inches(1.2),
                font_size=36, color=WHITE, bold=True, alignment=PP_ALIGN.CENTER)
    if subtitle:
        add_textbox(slide, subtitle,
                    Inches(1), Inches(3.7), SLIDE_WIDTH - Inches(2), Inches(0.8),
                    font_size=20, color=RGBColor(0xC8, 0xE6, 0xC9), bold=False,
                    alignment=PP_ALIGN.CENTER)
...
circle = slide.shapes.add_shape(
    MSO_SHAPE.OVAL, Inches(5.666), Inches(1.0), Inches(2.0), Inches(2.0)
)
circle.fill.solid()
...
# Title
add_textbox(slide, "NutriTrack",
            Inches(1), Inches(3.2), SLIDE_WIDTH - Inches(2), Inches(1),
            font_size=54, color=WHITE, bold=True, alignment=PP_ALIGN.CENTER)
add_textbox(slide, "Nutritional Data Engineering Platform",
            Inches(1), Inches(4.2), SLIDE_WIDTH - Inches(2), Inches(0.6),
            font_size=24, color=RGBColor(0xC8, 0xE6, 0xC9), bold=False,
            alignment=PP_ALIGN.CENTER)
add_textbox(slide, "Reetika Gautam",
            Inches(1), Inches(5.2), SLIDE_WIDTH - Inches(2), Inches(0.5),
            font_size=20, color=WHITE, bold=False, alignment=PP_ALIGN.CENTER)
add_textbox(slide, "RNCP37638 -- Expert in Massive Data Infrastructures\nLevel 7  |  April 2026  |  Simplon.co",
            Inches(1), Inches(5.8), SLIDE_WIDTH - Inches(2), Inches(0.8),
            font_size=14, color=RGBColor(0xA5, 0xD6, 0xA7), bold=False,
            alignment=PP_ALIGN.CENTER)
...
for i, (title, desc, time, comps, color) in enumerate(blocks):
    ...
    # Time label below
    add_textbox(slide, time, x, y_pos + box_h + Inches(0.1), box_w, Inches(0.3),
                font_size=12, color=GRAY, bold=True, alignment=PP_ALIGN.CENTER)
    # Competencies above
    if comps:
        add_textbox(slide, comps, x, y_pos - Inches(0.35), box_w, Inches(0.3),
                    font_size=10, color=color, bold=False, alignment=PP_ALIGN.CENTER)
    ...
    if i < len(blocks) - 1:
        ...
        arrow = slide.shapes.add_shape(
            ...
            arrow_x, y_pos + box_h / 2 - Inches(0.12),
            arrow_w - Inches(0.1), Inches(0.24)
        )
        arrow.fill.solid()
...
# Bottom bar
add_textbox(slide, "Live demos throughout   |   Report handed to jury   |   Code on GitHub",
            Inches(1), Inches(5.5), SLIDE_WIDTH - Inches(2), Inches(0.4),
            font_size=13, color=GRAY, bold=False, alignment=PP_ALIGN.CENTER)
add_slide_number(slide, slide_num)
...
for i, (title, desc, color) in enumerate(problems):
    ...
    add_textbox(slide, title, x, y_pos + Inches(0.3), card_w, Inches(0.4),
                font_size=20, color=RED, bold=True, alignment=PP_ALIGN.CENTER)
    add_textbox(slide, desc, x, y_pos + Inches(0.8), card_w, Inches(1.0),
                font_size=12, color=DARK_GRAY, bold=False, alignment=PP_ALIGN.CENTER)

add_textbox(slide, "Nutritionists, analysts, and users cannot trust or use the data.",
            Inches(1), Inches(5.0), SLIDE_WIDTH - Inches(2), Inches(0.5),
            font_size=20, color=RED, bold=False, alignment=PP_ALIGN.CENTER)
add_slide_number(slide, slide_num)
...
for i, (title, desc, color) in enumerate(solutions):
    ...
    add_textbox(slide, title, x, y_pos + Inches(0.25), card_w, Inches(0.4),
                font_size=20, color=GREEN, bold=True, alignment=PP_ALIGN.CENTER)
    add_textbox(slide, desc, x, y_pos + Inches(0.75), card_w, Inches(0.8),
                font_size=12, color=DARK_GRAY, bold=False, alignment=PP_ALIGN.CENTER)

# Stats bar
stats = "3M+ products   |   15 services   |   7 DAGs   |   6 dashboards   |   1 command to deploy"
stats_bg = add_rounded_box(slide, Inches(1.5), Inches(4.5),
                           SLIDE_WIDTH - Inches(3), Inches(0.55),
                           RGBColor(0xE8, 0xF5, 0xE9), GREEN)
add_textbox(slide, stats, Inches(1.5), Inches(4.55),
            SLIDE_WIDTH - Inches(3), Inches(0.45),
...
for i, (label, color) in enumerate(flow_items_r1):
    ...
    add_textbox(slide, label, x, y1 + Inches(0.15), bw, bh - Inches(0.3),
                font_size=12, color=color, bold=True, alignment=PP_ALIGN.CENTER)
    if i < len(flow_items_r1) - 1:
        arrow = slide.shapes.add_shape(
            MSO_SHAPE.RIGHT_ARROW,
            x + bw + Inches(0.05), y1 + bh / 2 - Inches(0.1),
            gp - Inches(0.1), Inches(0.2)
        )
        arrow.fill.solid()
        arrow.fill.fore_color.rgb = LIGHT_GRAY
        arrow.line.fill.background()
...
for label, color, x in flow_items_r2:
    ...
    add_textbox(slide, label, x, y2 + Inches(0.15), Inches(2.2), bh - Inches(0.3),
                font_size=12, color=color, bold=True, alignment=PP_ALIGN.CENTER)
...
for label, color, x in flow_items_r3:
    ...
    add_textbox(slide, label, x, y3 + Inches(0.15), Inches(2.2), bh - Inches(0.3),
                font_size=12, color=color, bold=True, alignment=PP_ALIGN.CENTER)
...
for label, x in users:
    add_textbox(slide, label, x, y3 + bh + Inches(0.05), Inches(2.2), Inches(0.25),
                font_size=10, color=GRAY, bold=False, alignment=PP_ALIGN.CENTER)

# Down arrows from App DB to row 2
for target_x in [Inches(0.5), Inches(3.6), Inches(9.5)]:
    darrow = slide.shapes.add_shape(
        MSO_SHAPE.DOWN_ARROW,
        sx + 3 * (bw + gp) + bw / 2 - Inches(0.1), y1 + bh + Inches(0.05),
...
add_textbox(slide, "docker compose up -d",
            Inches(3), Inches(1.4), Inches(7), Inches(0.5),
...
for ci, (cat_title, color, services) in enumerate(categories):
    ...
    add_textbox(slide, cat_title, x, y_cat + Inches(0.03), cat_w, Inches(0.35),
    ...
    for si, svc in enumerate(services):
        ...
        add_textbox(slide, svc, sx_inner, sy + Inches(0.05), sw, Inches(0.35),
                    font_size=9, color=color, bold=True, alignment=PP_ALIGN.CENTER)

# Why callout
add_why_callout(slide, "Docker Compose = reproducible environment. Any machine with Docker can run the full platform. No \"works on my machine\" issues.", Inches(5.2))
add_slide_number(slide, slide_num)
...
layers = [
    ("EXTRACT", GREEN, ["OFF API (REST + Parquet)", "BeautifulSoup (Scraping)", "DuckDB (Big data SQL)"], "3 source types per C8 req."),
    ("ORCHESTRATE", PURPLE, ["Apache Airflow 2.8 -- 7 DAGs, Celery, Scheduler"], "vs Prefect: more mature, better UI"),
    ("STORE", BLUE, ["PostgreSQL 16 (OLTP + DW)", "MinIO (S3 Data Lake)", "Redis 7 (Cache + Broker)"], "PG: ACID + RGPD. MinIO: free S3"),
    ("SERVE", ACCENT, ["FastAPI (Async + JWT)", "Superset 6 (BI Dashboards)", "Streamlit (User Frontend)"], "3 audiences: dev, analyst, user"),
...
for i, (label, color, tools, why) in enumerate(layers):
    ...
    add_textbox(slide, label, lbl_x, y + Inches(0.13), lbl_w, Inches(0.35),
                font_size=11, color=WHITE, bold=True, alignment=PP_ALIGN.CENTER)

    # Tools
    tool_text = "   |   ".join(tools)
    add_textbox(slide, tool_text, items_x, y + Inches(0.1), Inches(7.2), Inches(0.4),
                font_size=11, color=DARK_GRAY, bold=False)

    # Why
    add_textbox(slide, why, why_x, y + Inches(0.1), why_w, Inches(0.5),
...
for i, (chosen, chosen_desc, rejected, rejected_desc) in enumerate(decisions):
    x = sx + i * (card_w + gp)
    # "Selected" label
    add_textbox(slide, "Selected", x, y_chosen - Inches(0.25), card_w, Inches(0.25),
                font_size=9, color=GREEN, bold=False, alignment=PP_ALIGN.CENTER)
    # Chosen box
    light_green = RGBColor(0xE8, 0xF5, 0xE9)
    box = add_rounded_box(slide, x, y_chosen, card_w, card_h_chosen, light_green, GREEN)
    add_textbox(slide, chosen, x, y_chosen + Inches(0.15), card_w, Inches(0.35),
                font_size=14, color=GREEN, bold=True, alignment=PP_ALIGN.CENTER)
    add_textbox(slide, chosen_desc, x, y_chosen + Inches(0.55), card_w, Inches(0.9),
                font_size=10, color=DARK_GRAY, bold=False, alignment=PP_ALIGN.CENTER)

    # VS label
    vs_box = add_rounded_box(slide, x + card_w / 2 - Inches(0.3), y_vs,
                             Inches(0.6), Inches(0.3),
                             RGBColor(0xFF, 0xF8, 0xE1), ACCENT)
    add_textbox(slide, "vs", x + card_w / 2 - Inches(0.3), y_vs + Inches(0.02),
                Inches(0.6), Inches(0.25),
                font_size=10, color=ACCENT, bold=True, alignment=PP_ALIGN.CENTER)
    ...
    add_textbox(slide, rejected, x, y_rejected + Inches(0.1), card_w, Inches(0.3),
                font_size=12, color=GRAY, bold=True, alignment=PP_ALIGN.CENTER)
    add_textbox(slide, rejected_desc, x, y_rejected + Inches(0.45), card_w, Inches(0.5),
                font_size=9, color=GRAY, bold=False, alignment=PP_ALIGN.CENTER)
...
zones = [
    ("App Schema", "The Live Application\n\nproducts, users, meals\nbrands, categories\n\nUsed by: FastAPI + Streamlit", ACCENT),
...
for i, (title, desc, color) in enumerate(zones):
    ...
    add_textbox(slide, title, x, y_pos + Inches(0.2), card_w, Inches(0.4),
                font_size=18, color=color, bold=True, alignment=PP_ALIGN.CENTER)
    add_textbox(slide, desc, x + Inches(0.2), y_pos + Inches(0.7), card_w - Inches(0.4), card_h - Inches(1.0),
                font_size=11, color=DARK_GRAY, bold=False, alignment=PP_ALIGN.CENTER)
...
for i in range(2):
    ...
    arrow = slide.shapes.add_shape(
        MSO_SHAPE.RIGHT_ARROW,
        arrow_x, y_pos + card_h / 2 - Inches(0.1),
        gp - Inches(0.2), Inches(0.2)
    )
    arrow.fill.solid()
    arrow.fill.fore_color.rgb = LIGHT_GRAY
    arrow.line.fill.background()
    add_textbox(slide, "ETL", arrow_x, y_pos + card_h / 2 - Inches(0.35),
                gp, Inches(0.2), font_size=9, color=GRAY, bold=True,
                alignment=PP_ALIGN.CENTER)
...
add_textbox(slide, "Data Warehouse (PostgreSQL)", dw_x + Inches(0.2), y_pos + Inches(0.15),
            col_w - Inches(0.4), Inches(0.35), font_size=16, color=BLUE, bold=True)
add_bullet_list(slide, dw_items, dw_x + Inches(0.3), y_pos + Inches(0.6),
                col_w - Inches(0.6), col_h - Inches(0.8),
                font_size=12, color=DARK_GRAY, bullet_color=BLUE)

# Lake box
light_purple = RGBColor(0xF3, 0xE5, 0xF5)
add_rounded_box(slide, lake_x, y_pos, col_w, col_h, light_purple, PURPLE)
add_textbox(slide, "Data Lake (MinIO)", lake_x + Inches(0.2), y_pos + Inches(0.15),
            col_w - Inches(0.4), Inches(0.35), font_size=16, color=PURPLE, bold=True)
add_bullet_list(slide, lake_items, lake_x + Inches(0.3), y_pos + Inches(0.6),
                col_w - Inches(0.6), col_h - Inches(0.8),
                font_size=12, color=DARK_GRAY, bullet_color=PURPLE)

# RGPD boundary
add_textbox(slide, "RGPD Boundary: User data never enters the lake. Parquet files are immutable -- you cannot delete one user's rows.",
            Inches(1.5), Inches(5.3), SLIDE_WIDTH - Inches(3), Inches(0.5),
...
circle_p = slide.shapes.add_shape(
    MSO_SHAPE.OVAL, Inches(0.6) + card_w / 2 - Inches(0.35), y_pos + Inches(0.15),
    Inches(0.7), Inches(0.7)
)
circle_p.fill.solid()
circle_p.fill.fore_color.rgb = GREEN
circle_p.line.fill.background()
add_textbox(slide, "Data Producers", Inches(0.6), y_pos + Inches(0.9),
            card_w, Inches(0.35), font_size=16, color=GREEN, bold=True,
            alignment=PP_ALIGN.CENTER)
add_bullet_list(slide, prod_items, Inches(1.0), y_pos + Inches(1.35),
                card_w - Inches(0.8), card_h - Inches(1.5),
                font_size=12, color=DARK_GRAY, bullet_color=GREEN)
...
circle_c = slide.shapes.add_shape(
    MSO_SHAPE.OVAL, Inches(6.5) + card_w / 2 - Inches(0.35), y_pos + Inches(0.15),
    Inches(0.7), Inches(0.7)
)
circle_c.fill.solid()
circle_c.fill.fore_color.rgb = BLUE
circle_c.line.fill.background()
add_textbox(slide, "Data Consumers", Inches(6.5), y_pos + Inches(0.9),
            card_w, Inches(0.35), font_size=16, color=BLUE, bold=True,
            alignment=PP_ALIGN.CENTER)
add_bullet_list(slide, cons_items, Inches(6.9), y_pos + Inches(1.35),
                card_w - Inches(0.8), card_h - Inches(1.5),
                font_size=12, color=DARK_GRAY, bullet_color=BLUE)
...
for i, (letter, desc) in enumerate(smart):
    ...
    # Letter circle
    circle = slide.shapes.add_shape(
        MSO_SHAPE.OVAL, x + bw / 2 - Inches(0.3), y_pos - Inches(0.4),
    ...
    add_textbox(slide, desc, x, y_pos + Inches(0.5), bw, bh - Inches(0.3),
                font_size=13, color=DARK_GRAY, bold=False, alignment=PP_ALIGN.CENTER)

    # Arrow
    if i < len(smart) - 1:
        arrow = slide.shapes.add_shape(
            MSO_SHAPE.RIGHT_ARROW,
            x + bw + Inches(0.02), y_pos + Inches(0.3) + bh / 2 - Inches(0.08),
            gp - Inches(0.04), Inches(0.16)
        )
        arrow.fill.solid()
...
ppbg = add_rounded_box(slide, Inches(0.5), Inches(4.6),
                       SLIDE_WIDTH - Inches(1), Inches(0.55),
                       RGBColor(0xE3, 0xF2, 0xFD), BLUE)
add_textbox(slide, pre_proj, Inches(0.7), Inches(4.65),
            SLIDE_WIDTH - Inches(1.4), Inches(0.45),
            font_size=12, color=BLUE, bold=True, alignment=PP_ALIGN.CENTER)
add_slide_number(slide, slide_num)
...
for idx, (num, title, desc, color) in enumerate(topo_parts):
    ...
    # Number circle
    circle = slide.shapes.add_shape(
        MSO_SHAPE.OVAL, x + Inches(0.15), y + ch / 2 - Inches(0.25),
    ...
    add_textbox(slide, f"{title}: {desc}",
                x + Inches(0.8), y + Inches(0.2), cw - Inches(1.0), ch - Inches(0.4),
                font_size=13, color=DARK_GRAY, bold=False)

add_why_callout(slide, "C2 requires mapping ALL data in 4 dimensions -- semantics, models, flows, and access conditions.", Inches(5.6))
add_slide_number(slide, slide_num)
...
for ri, (row_label, color, services) in enumerate(arch_rows):
    ...
    add_textbox(slide, row_label, Inches(0.3), y + Inches(0.15), Inches(1.8), Inches(0.4),
    ...
    for si, (svc_name, audience) in enumerate(services):
        ...
        add_textbox(slide, svc_name, x, y + Inches(0.1), svc_w, Inches(0.3),
                    font_size=10, color=color, bold=True, alignment=PP_ALIGN.CENTER)
        if audience:
            add_textbox(slide, audience, x, y + Inches(0.4), svc_w, Inches(0.2),
                        font_size=8, color=GRAY, bold=False, alignment=PP_ALIGN.CENTER)
...
add_table(slide, Inches(0.5), Inches(1.6),
          SLIDE_WIDTH - Inches(1), Inches(4.0),
          headers, rows_data)
add_slide_number(slide, slide_num)
...
for i, (title, desc, color) in enumerate(topics):
    ...
    add_textbox(slide, title, x, y_pos + Inches(0.2), card_w, Inches(0.35),
                font_size=16, color=color, bold=True, alignment=PP_ALIGN.CENTER)
    add_textbox(slide, desc, x + Inches(0.2), y_pos + Inches(0.65), card_w - Inches(0.4), card_h - Inches(0.9),
                font_size=11, color=DARK_GRAY, bold=False, alignment=PP_ALIGN.CENTER)

# Schedule bar
schedule_bar = add_rounded_box(slide, Inches(0.5), Inches(5.0),
                               SLIDE_WIDTH - Inches(1), Inches(0.5),
                               RGBColor(0xE8, 0xF5, 0xE9), GREEN)
add_textbox(slide, "Weekly (1h/week)   |   Sources verified   |   docs/veille_technologique.md",
            Inches(0.7), Inches(5.05), SLIDE_WIDTH - Inches(1.4), Inches(0.4),
...
for i, (title, desc, color) in enumerate(rgpd_cards):
    ...
    add_textbox(slide, desc, x + Inches(0.15), y_pos + Inches(0.65), card_w - Inches(0.3), card_h - Inches(0.9),
                font_size=10, color=DARK_GRAY, bold=False, alignment=PP_ALIGN.CENTER)

add_why_callout(slide, "Personal data stays in PostgreSQL (row-level delete). Public product data goes to both DW and Lake. This is the RGPD boundary.", Inches(4.6))
add_slide_number(slide, slide_num)
...
for i, (title, desc, week) in enumerate(phases):
    ...
    add_textbox(slide, title, x, y_pos + Inches(0.15), bw, Inches(0.3),
                font_size=14, color=GREEN, bold=True, alignment=PP_ALIGN.CENTER)
    add_textbox(slide, desc, x, y_pos + Inches(0.5), bw, Inches(0.8),
                font_size=10, color=DARK_GRAY, bold=False, alignment=PP_ALIGN.CENTER)
    add_textbox(slide, week, x, y_pos + bh + Inches(0.05), bw, Inches(0.25),
                font_size=10, color=GRAY, bold=True, alignment=PP_ALIGN.CENTER)

    if i < len(phases) - 1:
        arrow = slide.shapes.add_shape(
            MSO_SHAPE.RIGHT_ARROW,
            x + bw + Inches(0.02), y_pos + bh / 2 - Inches(0.08),
            gp - Inches(0.04), Inches(0.16)
        )
        arrow.fill.solid()
        arrow.fill.fore_color.rgb = LIGHT_GREEN
...
for i, (text, color) in enumerate(info_boxes):
    ...
    add_textbox(slide, text, x + Inches(0.1), ib_y + Inches(0.1), ib_w - Inches(0.2), ib_h - Inches(0.2),
                font_size=10, color=color, bold=True, alignment=PP_ALIGN.CENTER)
...
for i, (title, desc) in enumerate(metrics):
    ...
    add_textbox(slide, title, x, y_pos + Inches(0.3), card_w, Inches(0.35),
                font_size=14, color=GREEN, bold=True, alignment=PP_ALIGN.CENTER)
    add_textbox(slide, desc, x, y_pos + Inches(0.8), card_w, Inches(0.5),
                font_size=11, color=DARK_GRAY, bold=False, alignment=PP_ALIGN.CENTER)

# Tools bar
tools_bar = add_rounded_box(slide, Inches(0.5), Inches(4.5),
                            SLIDE_WIDTH - Inches(1), Inches(0.5),
                            RGBColor(0xE3, 0xF2, 0xFD), BLUE)
add_textbox(slide, "Tools:  Airflow UI  |  Grafana SLA Dashboard  |  Git history",
            Inches(0.7), Inches(4.55), SLIDE_WIDTH - Inches(1.4), Inches(0.4),
            font_size=13, color=BLUE, bold=True, alignment=PP_ALIGN.CENTER)
add_slide_number(slide, slide_num)
...
for i, (title, items, color) in enumerate(audiences):
    ...
    add_textbox(slide, title, x, y_pos + Inches(0.2), card_w, Inches(0.35),
                font_size=16, color=color, bold=True, alignment=PP_ALIGN.CENTER)
    add_bullet_list(slide, items, x + Inches(0.3), y_pos + Inches(0.65),
                    card_w - Inches(0.6), card_h - Inches(0.9),
                    font_size=12, color=DARK_GRAY, bullet_color=color)

add_why_callout(slide, "Right tool for right audience. Technical stakeholders get Swagger; business gets Superset; users get Streamlit.", Inches(5.0))
add_slide_number(slide, slide_num)
...
for i, (title, desc, color) in enumerate(sources):
    ...
    add_textbox(slide, title, x, y_pos + Inches(0.2), src_w, Inches(0.3),
                font_size=14, color=color, bold=True, alignment=PP_ALIGN.CENTER)
    add_textbox(slide, desc, x, y_pos + Inches(0.6), src_w, Inches(0.4),
                font_size=10, color=DARK_GRAY, bold=False, alignment=PP_ALIGN.CENTER)
...
agg_box = add_rounded_box(slide, agg_x, agg_y, agg_w, Inches(0.6),
                          RGBColor(0xE8, 0xF5, 0xE9), GREEN)
add_textbox(slide, "aggregate_clean.py", agg_x, agg_y + Inches(0.1), agg_w, Inches(0.4),
            font_size=14, color=GREEN, bold=True, alignment=PP_ALIGN.CENTER)

add_why_callout(slide, "C8 requires 5 source types: REST API, data file, web scraping, database, big data system.", Inches(4.8))
add_slide_number(slide, slide_num)
...
add_textbox(slide, "extract_off_api.py", Inches(0.5), Inches(1.5),
            Inches(5), Inches(0.35), font_size=16, color=GREEN, bold=True)
add_bullet_list(slide, steps_left, Inches(0.5), Inches(2.0),
                Inches(5), Inches(3.5), font_size=13, color=DARK_GRAY, bullet_color=GREEN)
...
add_textbox(slide, "Script structure (all 5):", Inches(7.0), Inches(1.65),
            Inches(5), Inches(0.3), font_size=14, color=BLUE, bold=True)
add_bullet_list(slide, struct_items, Inches(7.0), Inches(2.1),
                Inches(5), Inches(2.8), font_size=12, color=DARK_GRAY, bullet_color=BLUE)
...
add_textbox(slide, "Web Scraping", Inches(0.5), Inches(1.6), Inches(5.5), Inches(0.35),
            font_size=18, color=PURPLE, bold=True, alignment=PP_ALIGN.CENTER)
add_textbox(slide, "extract_scraping.py", Inches(0.5), Inches(2.0), Inches(5.5), Inches(0.3),
            font_size=13, color=PURPLE, bold=True, alignment=PP_ALIGN.CENTER)
add_bullet_list(slide, scraping_items, Inches(0.8), Inches(2.5),
                Inches(5), Inches(2.5), font_size=12, color=DARK_GRAY, bullet_color=PURPLE)
...
add_textbox(slide, "DuckDB Big Data", Inches(6.8), Inches(1.6), Inches(5.5), Inches(0.35),
            font_size=18, color=RED, bold=True, alignment=PP_ALIGN.CENTER)
add_textbox(slide, "extract_duckdb.py", Inches(6.8), Inches(2.0), Inches(5.5), Inches(0.3),
            font_size=13, color=RED, bold=True, alignment=PP_ALIGN.CENTER)
add_bullet_list(slide, duckdb_items, Inches(7.1), Inches(2.5),
                Inches(5), Inches(2.5), font_size=12, color=DARK_GRAY, bullet_color=RED)
...
add_textbox(slide, "aggregate_clean.py -- 7 cleaning steps",
            Inches(0.5), Inches(1.4), Inches(10), Inches(0.4),
...
for i, (num, desc, color) in enumerate(cleaning_steps):
    ...
    add_textbox(slide, f"{num}  {desc}",
                Inches(0.7), y + Inches(0.08), SLIDE_WIDTH - Inches(1.4), Inches(0.4),
                font_size=13, color=DARK_GRAY, bold=False)
...
add_table(slide, Inches(0.5), Inches(1.6),
          SLIDE_WIDTH - Inches(1), Inches(3.5),
          sql_headers, sql_rows)

add_textbox(slide, "All queries documented with EXPLAIN ANALYZE and optimization rationale.",
            Inches(0.5), Inches(5.5), SLIDE_WIDTH - Inches(1), Inches(0.4),
...
for name, color, x, y in tables:
    ...
    add_textbox(slide, name, x, y + Inches(0.08), Inches(2.0), Inches(0.35),
...
add_bullet_list(slide, db_details, Inches(6.8), Inches(2.0),
                Inches(5.2), Inches(3.4),
                font_size=13, color=DARK_GRAY, bullet_color=GREEN)
add_slide_number(slide, slide_num)
...
add_textbox(slide, "Endpoints", Inches(0.5), Inches(1.5),
            Inches(5), Inches(0.35), font_size=16, color=ACCENT, bold=True)

y_ep = Inches(2.0)
for i, ep in enumerate(endpoints):
    light_accent = RGBColor(0xFF, 0xF3, 0xE0)
    add_rounded_box(slide, Inches(0.5), y_ep + i * Inches(0.45),
                    Inches(5.2), Inches(0.38), light_accent, ACCENT)
    add_textbox(slide, ep, Inches(0.7), y_ep + i * Inches(0.45) + Inches(0.04),
                Inches(4.8), Inches(0.3),
                font_size=11, color=DARK_GRAY, bold=False, font_name="Courier New")

# Right: Auth flow
add_textbox(slide, "Auth Flow", Inches(7), Inches(1.5),
            Inches(5), Inches(0.35), font_size=16, color=BLUE, bold=True)
...
for i, (title, desc, color) in enumerate(auth_steps):
    ...
    add_textbox(slide, title, Inches(7.5), y + Inches(0.05), auth_w, Inches(0.3),
                font_size=12, color=color, bold=True, alignment=PP_ALIGN.CENTER)
    add_textbox(slide, desc, Inches(7.5), y + Inches(0.35), auth_w, Inches(0.25),
                font_size=9, color=GRAY, bold=False, alignment=PP_ALIGN.CENTER)

    if i < len(auth_steps) - 1:
        darrow = slide.shapes.add_shape(
            MSO_SHAPE.DOWN_ARROW,
            Inches(7.5) + auth_w / 2 - Inches(0.08), y + Inches(0.72),
...
add_textbox(slide, "User App (port 8501)", Inches(0.5), Inches(1.6), Inches(5.5), Inches(0.35),
            font_size=18, color=ACCENT, bold=True, alignment=PP_ALIGN.CENTER)
add_bullet_list(slide, user_items, Inches(0.8), Inches(2.1),
                Inches(5), Inches(3.0), font_size=12, color=DARK_GRAY, bullet_color=ACCENT)
...
add_textbox(slide, "Data Catalog (C20)", Inches(6.8), Inches(1.6), Inches(5.5), Inches(0.35),
            font_size=18, color=PURPLE, bold=True, alignment=PP_ALIGN.CENTER)
add_bullet_list(slide, catalog_items, Inches(7.1), Inches(2.1),
                Inches(5), Inches(3.0), font_size=12, color=DARK_GRAY, bullet_color=PURPLE)
...
for name, color, x, y in facts:
    box = add_rounded_box(slide, x, y, Inches(2.2), Inches(1.0),
                          RGBColor(0xFF, 0xF3, 0xE0), ACCENT)
    add_textbox(slide, name, x, y + Inches(0.15), Inches(2.2), Inches(0.7),
...
for name, color, x, y in dims:
    ...
    add_textbox(slide, name, x, y + Inches(0.1), Inches(1.8), Inches(0.4),
                font_size=10, color=BLUE, bold=True, alignment=PP_ALIGN.CENTER)

# Bottom summary
summary_bar = add_rounded_box(slide, Inches(1.5), Inches(6.0),
                              SLIDE_WIDTH - Inches(3), Inches(0.5),
                              RGBColor(0xE8, 0xF5, 0xE9), GREEN)
add_textbox(slide, "7 dims  +  2 facts  +  6 datamart views    |    Bottom-up (Kimball)",
            Inches(1.5), Inches(6.05), SLIDE_WIDTH - Inches(3), Inches(0.4),
            font_size=13, color=GREEN, bold=True, alignment=PP_ALIGN.CENTER)
add_slide_number(slide, slide_num)
...
add_table(slide, Inches(0.5), Inches(1.6),
          SLIDE_WIDTH - Inches(1), Inches(3.2),
          dm_headers, dm_rows)

add_why_callout(slide, "Datamarts are pre-built SQL views so analysts don't need to write complex star-schema joins themselves.", Inches(5.3))
add_slide_number(slide, slide_num)
...
add_textbox(slide, "02:00", Inches(0.3), Inches(2.8), Inches(0.8), Inches(0.3),
            font_size=10, color=GRAY, bold=True)
for i, (name, color) in enumerate(extract_dags):
    ...
    add_textbox(slide, name, Inches(1.0), y + Inches(0.08), Inches(2.5), Inches(0.35),
                font_size=10, color=color, bold=True, alignment=PP_ALIGN.CENTER)
...
# Clean DAG (column 2)
add_textbox(slide, "04:00", Inches(4.3), Inches(3.0), Inches(0.8), Inches(0.3),
            font_size=10, color=GRAY, bold=True)
...
add_textbox(slide, "aggregate_clean", Inches(4.3), Inches(2.28), Inches(2.5), Inches(0.35),
            font_size=10, color=ACCENT, bold=True, alignment=PP_ALIGN.CENTER)

# Arrows to DW and Lake
arrow_r1 = slide.shapes.add_shape(
    MSO_SHAPE.RIGHT_ARROW,
    Inches(6.9), Inches(2.15), Inches(0.6), Inches(0.16)
)
arrow_r1.fill.solid()
...
arrow_r2 = slide.shapes.add_shape(
    MSO_SHAPE.RIGHT_ARROW,
    Inches(6.9), Inches(2.75), Inches(0.6), Inches(0.16)
)
arrow_r2.fill.solid()
...
add_textbox(slide, "05:00", Inches(7.6), Inches(3.5), Inches(0.8), Inches(0.3),
            font_size=10, color=GRAY, bold=True)
add_textbox(slide, "parallel", Inches(7.6), Inches(1.7), Inches(2.5), Inches(0.3),
            font_size=10, color=PURPLE, bold=True, alignment=PP_ALIGN.CENTER)
...
add_textbox(slide, "load_warehouse", Inches(7.6), Inches(2.08), Inches(2.5), Inches(0.35),
            font_size=10, color=BLUE, bold=True, alignment=PP_ALIGN.CENTER)
...
add_textbox(slide, "datalake_ingest", Inches(7.6), Inches(2.68), Inches(2.5), Inches(0.35),
            font_size=10, color=PURPLE, bold=True, alignment=PP_ALIGN.CENTER)

# Backup DAG
add_textbox(slide, "06:00", Inches(0.3), Inches(4.5), Inches(0.8), Inches(0.3),
            font_size=10, color=GRAY, bold=True)
light_red = lighten((RED[0], RED[1], RED[2]), 0.88)
add_rounded_box(slide, Inches(1.0), Inches(4.3), Inches(2.5), Inches(0.5), light_red, RED)
add_textbox(slide, "backup_maint.", Inches(1.0), Inches(4.38), Inches(2.5), Inches(0.35),
            font_size=10, color=RED, bold=True, alignment=PP_ALIGN.CENTER)

# Sensor note
sensor_bg = add_rounded_box(slide, Inches(6.5), Inches(4.0),
                            Inches(5.5), Inches(0.7),
                            RGBColor(0xE3, 0xF2, 0xFD), BLUE)
add_textbox(slide, "ExternalTaskSensor ensures DW and Lake wait for cleaning to finish",
            Inches(6.7), Inches(4.1), Inches(5.1), Inches(0.5),
            font_size=11, color=BLUE, bold=False)
...
scds = [
    ("Type 1 -- Overwrite", "(dim_brand)", "Brand name misspelled? Just overwrite it. No history needed for corrections.", GREEN),
    ("Type 2 -- Historical", "(dim_product)", "Product changes? Close old row (end_date, is_current=false), insert new row. Full history.", BLUE),
    ("Type 3 -- Previous Value", "(dim_country)", "Country list changes? Keep previous_country_list column. One level of history.", PURPLE),
]
...
for i, (title, table_name, desc, color) in enumerate(scds):
    ...
    light = lighten((color[0], color[1], color[2]), 0.92)
    add_rounded_box(slide, Inches(0.5), y, SLIDE_WIDTH - Inches(1), rh, light, color)
    add_textbox(slide, f"{title}  {table_name}",
                Inches(0.8), y + Inches(0.15), SLIDE_WIDTH - Inches(1.6), Inches(0.35),
                font_size=16, color=color, bold=True)
    add_textbox(slide, desc,
                Inches(0.8), y + Inches(0.55), SLIDE_WIDTH - Inches(1.6), Inches(0.6),
                font_size=12, color=DARK_GRAY, bold=False)

add_why_callout(slide, "Change detection uses IS DISTINCT FROM in the ETL. All 3 types are integrated into the warehouse loading DAG.", Inches(6.2))
add_slide_number(slide, slide_num)
...
for i, (label, color) in enumerate(alert_steps):
    ...
    add_textbox(slide, label, x, y_pos + Inches(0.2), bw, bh - Inches(0.4),
                font_size=11, color=color, bold=True, alignment=PP_ALIGN.CENTER)
...
for i, (title, target) in enumerate(sla_metrics):
    ...
    add_textbox(slide, title, x, y_pos + Inches(0.2), card_w, Inches(0.35),
                font_size=14, color=GREEN, bold=True, alignment=PP_ALIGN.CENTER)
    add_textbox(slide, target, x, y_pos + Inches(0.7), card_w, Inches(0.4),
                font_size=18, color=GREEN, bold=True, alignment=PP_ALIGN.CENTER)

# ITIL Priority
itil_bg = add_rounded_box(slide, Inches(0.5), Inches(4.0),
                          SLIDE_WIDTH - Inches(1), Inches(0.9),
                          RGBColor(0xFF, 0xF3, 0xE0), ACCENT)
add_textbox(slide, "ITIL Priority Matrix:  P1 Critical <1h  |  P2 High <4h  |  P3 Medium <24h  |  P4 Low: next sprint\nEscalation: L1 (auto-restart) -> L2 (engineer) -> L3 (architecture review)",
            Inches(0.7), Inches(4.05), SLIDE_WIDTH - Inches(1.4), Inches(0.8),
...
add_textbox(slide, "Backup Script", Inches(0.5), Inches(1.6), Inches(5.5), Inches(0.35),
            font_size=18, color=BLUE, bold=True, alignment=PP_ALIGN.CENTER)
add_bullet_list(slide, backup_items, Inches(0.8), Inches(2.1),
                Inches(5), Inches(3.0), font_size=13, color=DARK_GRAY, bullet_color=BLUE)
...
add_textbox(slide, "Documented Procedures", Inches(6.8), Inches(1.6), Inches(5.5), Inches(0.35),
            font_size=18, color=GREEN, bold=True, alignment=PP_ALIGN.CENTER)
add_bullet_list(slide, proc_items, Inches(7.1), Inches(2.1),
                Inches(5), Inches(3.0), font_size=13, color=DARK_GRAY, bullet_color=GREEN)
...
for i, (title, desc, color) in enumerate(layers):
    ...
    add_textbox(slide, desc, x + Inches(0.2), y_pos + Inches(0.8), card_w - Inches(0.4), card_h - Inches(1.0),
                font_size=12, color=DARK_GRAY, bold=False, alignment=PP_ALIGN.CENTER)

    if i < len(layers) - 1:
        arrow = slide.shapes.add_shape(
            MSO_SHAPE.RIGHT_ARROW,
            x + card_w + Inches(0.1), y_pos + card_h / 2 - Inches(0.12),
            gp - Inches(0.2), Inches(0.24)
        )
        arrow.fill.solid()
        arrow.fill.fore_color.rgb = color
        arrow.line.fill.background()
        label_text = "clean" if i == 0 else "aggregate"
        add_textbox(slide, label_text, x + card_w + Inches(0.1), y_pos + card_h / 2 - Inches(0.35),
                    gp - Inches(0.2), Inches(0.2),
                    font_size=10, color=color, bold=True, alignment=PP_ALIGN.CENTER)

# V/V/V bar
vvv_bar = add_rounded_box(slide, Inches(0.5), Inches(4.9),
                          SLIDE_WIDTH - Inches(1), Inches(0.5),
                          RGBColor(0xE8, 0xF5, 0xE9), GREEN)
add_textbox(slide, "Addresses: Volume (3M+ products)  |  Variety (JSON, Parquet, CSV)  |  Velocity (daily/weekly schedules)",
            Inches(0.7), Inches(4.95), SLIDE_WIDTH - Inches(1.4), Inches(0.4),
            font_size=12, color=GREEN, bold=True, alignment=PP_ALIGN.CENTER)
add_slide_number(slide, slide_num)
...
for i, (title, items, color) in enumerate(vvv):
    ...
    light = lighten((color[0], color[1], color[2]), 0.9)
    add_rounded_box(slide, x, y_pos, card_w, card_h, light, color)
    add_textbox(slide, title, x, y_pos + Inches(0.2), card_w, Inches(0.45),
                font_size=22, color=color, bold=True, alignment=PP_ALIGN.CENTER)
    add_bullet_list(slide, items, x + Inches(0.3), y_pos + Inches(0.8),
                    card_w - Inches(0.6), card_h - Inches(1.0),
                    font_size=13, color=DARK_GRAY, bullet_color=color)
...
add_why_callout(slide, "Custom JSON catalog was chosen because Atlas and DataHub add significant infrastructure for a project at this scale. The Streamlit browser provides search and browse capabilities.", Inches(5.3))
add_slide_number(slide, slide_num)
...
add_textbox(slide, "Streamlit Catalog Page", Inches(0.5), Inches(1.5),
            Inches(10), Inches(0.4), font_size=18, color=PURPLE, bold=True)
...
for i, feat in enumerate(catalog_features):
    ...
    add_textbox(slide, feat, Inches(0.7), y + Inches(0.06), Inches(8.1), Inches(0.35),
                font_size=12, color=DARK_GRAY, bold=False)
...
add_textbox(slide, "Group-Based Access (not individual)",
            Inches(0.5), Inches(1.5), Inches(10), Inches(0.4),
            font_size=18, color=DARK_GRAY, bold=True)

roles = [
    ("admin_role", "PostgreSQL: full  |  MinIO: all buckets  |  API: admin  |  Superset: Admin", GREEN),
    ("nutritionist_role", "PostgreSQL: read products+meals  |  MinIO: gold  |  API: nutritionist  |  Superset: Analyst", BLUE),
    ("app_readonly", "PostgreSQL: read products only  |  MinIO: gold (public)  |  API: user  |  Superset: Viewer", ACCENT),
]
...
for i, (role, perms, color) in enumerate(roles):
    ...
    # Role name
    txBox = slide.shapes.add_textbox(Inches(0.7), y + Inches(0.1),
    ...
    # Permissions
    add_textbox(slide, perms, Inches(3.3), y + Inches(0.15),
                Inches(9), Inches(0.45),
                font_size=11, color=DARK_GRAY, bold=False)

add_why_callout(slide, "Least-privilege principle: each role gets only what it needs. Consistent across all 4 systems. RGPD-compliant.", Inches(5.2))
add_slide_number(slide, slide_num)
...
for i, (name, desc) in enumerate(exporters):
    ...
    add_textbox(slide, name, x, y_exp + Inches(0.15), exp_w, Inches(0.3),
                font_size=13, color=RED, bold=True, alignment=PP_ALIGN.CENTER)
    add_textbox(slide, desc, x, y_exp + Inches(0.5), exp_w, Inches(0.3),
                font_size=10, color=DARK_GRAY, bold=False, alignment=PP_ALIGN.CENTER)

    # Down arrow
    darrow = slide.shapes.add_shape(
        MSO_SHAPE.DOWN_ARROW,
        x + exp_w / 2 - Inches(0.08), y_exp + exp_h + Inches(0.05),
        Inches(0.16), Inches(0.3)
    )
    darrow.fill.solid()
    darrow.fill.fore_color.rgb = LIGHT_GRAY
...
add_textbox(slide, "Prometheus   (scrapes all 4 exporters)",
            Inches(2.0), prom_y + Inches(0.1), Inches(8), Inches(0.5),
            font_size=14, color=ACCENT, bold=True, alignment=PP_ALIGN.CENTER)

# Down arrow to Grafana
darrow2 = slide.shapes.add_shape(
    MSO_SHAPE.DOWN_ARROW,
    Inches(6) - Inches(0.1), prom_y + Inches(0.75),
    Inches(0.2), Inches(0.3)
)
darrow2.fill.solid()
...
add_textbox(slide, "Grafana   (6 dashboards)",
            Inches(3.0), graf_y + Inches(0.1), Inches(6), Inches(0.5),
            font_size=14, color=GREEN, bold=True, alignment=PP_ALIGN.CENTER)
...
for bi, (block_name, color, comps) in enumerate(blocks_comp):
    ...
    add_textbox(slide, block_name, Inches(0.5), y + Inches(0.08), Inches(2.5), Inches(0.35),
                font_size=12, color=WHITE, bold=True, alignment=PP_ALIGN.CENTER)
    ...
    for ci, comp in enumerate(comps):
        ...
        add_textbox(slide, comp, x, y + Inches(0.1), cw, Inches(0.3),
                    font_size=9, color=color, bold=True, alignment=PP_ALIGN.CENTER)

# 21/21 badge
add_textbox(slide, "21/21", Inches(10), Inches(2.0), Inches(2), Inches(0.6),
            font_size=36, color=GREEN, bold=True, alignment=PP_ALIGN.CENTER)

# Summary bar
summary_bar = add_rounded_box(slide, Inches(0.5), Inches(4.8),
                              SLIDE_WIDTH - Inches(1), Inches(0.55),
                              RGBColor(0xE8, 0xF5, 0xE9), GREEN)
add_textbox(slide, "One integrated project  |  15 Docker services  |  Full RGPD compliance  |  All evaluations E1-E7",
            Inches(0.7), Inches(4.85), SLIDE_WIDTH - Inches(1.4), Inches(0.45),
            font_size=13, color=GREEN, bold=True, alignment=PP_ALIGN.CENTER)
add_slide_number(slide, slide_num)
...
add_textbox(slide, "What worked", Inches(0.5), Inches(1.6), Inches(5.5), Inches(0.4),
            font_size=18, color=GREEN, bold=True, alignment=PP_ALIGN.CENTER)
add_bullet_list(slide, worked, Inches(0.8), Inches(2.2),
                Inches(5), Inches(3.0), font_size=14, color=DARK_GRAY, bullet_color=GREEN)
...
add_textbox(slide, "Next steps", Inches(6.8), Inches(1.6), Inches(5.5), Inches(0.4),
            font_size=18, color=ACCENT, bold=True, alignment=PP_ALIGN.CENTER)
add_bullet_list(slide, next_steps, Inches(7.1), Inches(2.2),
                Inches(5), Inches(3.0), font_size=14, color=DARK_GRAY, bullet_color=ACCENT)
...
add_textbox(slide, "Demo Sequence (during the 60-minute presentation)",
            Inches(0.5), Inches(1.4), Inches(10), Inches(0.4),
            font_size=16, color=DARK_GRAY, bold=True)
...
for i, (num, desc, color) in enumerate(demos):
    ...
    add_rounded_box(slide, Inches(0.5), y, SLIDE_WIDTH - Inches(1), rh, light, color)
    add_textbox(slide, f"{num}  {desc}",
                Inches(0.7), y + Inches(0.06), SLIDE_WIDTH - Inches(1.4), Inches(0.35),
                font_size=12, color=DARK_GRAY, bold=False)
...
add_textbox(slide, "Thank You",
            Inches(1), Inches(3.3), SLIDE_WIDTH - Inches(2), Inches(1),
            font_size=54, color=WHITE, bold=True, alignment=PP_ALIGN.CENTER)
add_textbox(slide, "Questions?",
            Inches(1), Inches(4.3), SLIDE_WIDTH - Inches(2), Inches(0.6),
            font_size=28, color=RGBColor(0xC8, 0xE6, 0xC9), bold=False,
            alignment=PP_ALIGN.CENTER)
add_textbox(slide, "github.com/Reetika12795/NutriTrack",
            Inches(1), Inches(5.5), SLIDE_WIDTH - Inches(2), Inches(0.4),
            font_size=16, color=WHITE, bold=False, alignment=PP_ALIGN.CENTER)
add_textbox(slide, "reetika12795.github.io/NutriTrack",
            Inches(1), Inches(5.9), SLIDE_WIDTH - Inches(2), Inches(0.4),
            font_size=16, color=WHITE, bold=False, alignment=PP_ALIGN.CENTER)
add_slide_number(slide, slide_num)
