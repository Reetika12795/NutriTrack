...
Every technology was selected based on project requirements, resource constraints (zero CAPEX budget), and certification competency coverage.
...
| **Zero CAPEX** | All tools are open-source; no cloud services required |
| **OPEX < 100 EUR/year** | Only cost is optional domain + hosting for docs |
